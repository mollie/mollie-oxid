 ...
 */
class MultipartStream implements \_PhpScoper5c46f59d284a1\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5c46f59d284a1\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5c46f59d284a1\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5c46f59d284a1\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
