 ...
 */
class LimitStream implements \_PhpScoper5c46f59d284a1\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper5c46f59d284a1\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
