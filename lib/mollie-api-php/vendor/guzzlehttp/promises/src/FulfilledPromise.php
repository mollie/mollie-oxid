 ...
 */
class FulfilledPromise implements \_PhpScoper5c46f59d284a1\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5c46f59d284a1\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
