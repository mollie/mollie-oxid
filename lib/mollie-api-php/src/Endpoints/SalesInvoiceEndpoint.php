...
class SalesInvoiceEndpoint extends \Mollie\Api\Endpoints\CollectionEndpointAbstract
{
     ...
     * @return SalesInvoice
     */
    protected function getResourceObject() : \Mollie\Api\Resources\SalesInvoice
    {
     ...
     */
    protected function getResourceCollectionObject($count, $_links) : \Mollie\Api\Resources\SalesInvoiceCollection
    {
        return new \Mollie\Api\Resources\SalesInvoiceCollection($this->client, $count, $_links);
    }
    /**
     ...
     * @throws ApiException
     */
    public function create(array $data = []) : \Mollie\Api\Resources\SalesInvoice
    {
     ...
     * @throws ApiException
     */
    public function update($salesInvoiceId, array $data = []) : \Mollie\Api\Resources\SalesInvoice
    {
        if (empty($salesInvoiceId) || \strpos($salesInvoiceId, self::RESOURCE_ID_PREFIX) !== 0) {
            throw new \Mollie\Api\Exceptions\ApiException("Invalid sales invoice ID: '{$salesInvoiceId}'. A sales invoice ID should start with '" . self::RESOURCE_ID_PREFIX . "'.");
        }
     ...
     * @throws ApiException
     */
    public function get($salesInvoiceId, array $parameters = []) : \Mollie\Api\Resources\SalesInvoice
    {
        if (empty($salesInvoiceId) || \strpos($salesInvoiceId, self::RESOURCE_ID_PREFIX) !== 0) {
            throw new \Mollie\Api\Exceptions\ApiException("Invalid sales invoice ID: '{$salesInvoiceId}'. A sales invoice ID should start with '" . self::RESOURCE_ID_PREFIX . "'.");
        }
     ...
     */
    public function iterator(?string $from = null, ?int $limit = null, bool $iterateBackwards = \false) : \Mollie\Api\Resources\LazyCollection
    {
