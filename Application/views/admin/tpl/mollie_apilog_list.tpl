        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr class="listitem">
                <td valign="top" class="listfilter" align="left">
                    <div class="r1">
                        <div class="b1">
                            <input class="listedit" type="text" size="30" name="where[mollierequestlog][oxid]" value="[{$where.mollierequestlog.oxid}]">
                        </div>
                    </div>
                </td>
                <td valign="top" class="listfilter" colspan="2" nowrap>
                    <div class="r1"><div class="b1">
                            ...
                            <input class="listedit" type="text" size="9" name="where[mollierequestlog][oxid]" value="[{$where.mollierequestlog.oxid}]">
                        </div></div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="listheader" height="15" colspan="2"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'mollierequestlog', 'orderid', 'asc');document.search.submit();" class="listheader">OrderID</a></td>
                <td class="listheader" height="15" colspan="2"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'mollierequestlog', 'storeid', 'asc');document.search.submit();" class="listheader">StoreID</a></td>
                <td class="listheader" height="15" colspan="2"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'mollierequestlog', 'requesttype', 'asc');document.search.submit();" class="listheader">Requesttype</a></td>
